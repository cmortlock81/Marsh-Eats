<?php
/** Template shell for Restaurant Menu. */
...
?>
<div class="marsh-eats-app" data-marsh-eats-view="<?php echo esc_attr('restaurant_menu'); ?>" data-route="<?php echo esc_attr($route); ?>" data-restaurant-id="<?php echo esc_attr((string) ($atts['restaurant_id'] ?? '')); ?>" data-restaurant-slug="<?php echo esc_attr((string) ($atts['restaurant_slug'] ?? '')); ?>" data-order-id="<?php echo esc_attr((string) ($atts['order_id'] ?? '')); ?>">
    <div class="marsh-eats-shell">
        ...
        <main class="marsh-eats-main" tabindex="-1">
            <section class="marsh-eats-panel" data-marsh-eats-mount>
                <p class="marsh-eats-eyebrow"><?php echo esc_html__('Restaurant Menu', 'marsh-eats-bridge'); ?></p>
                <h1><?php echo esc_html__('Restaurant Menu', 'marsh-eats-bridge'); ?></h1>
                <p><?php echo esc_html__('Menu data loads from the Marsh Eats API.', 'marsh-eats-bridge'); ?></p>
